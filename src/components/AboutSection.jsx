            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 item-center">
                <div className="space-y-6">
                    ...
                    <p className="text-muted-foreground">
                        ...
                        techniquess to stay at the forefront of the ever-evolving web
                        landscape.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                        <a href="#contact"
                            className="cosmic-button"> Get In Touch
                            </a>
                        <a href="#contact"
                ...
                <div className="grid grid-cols-1 gap-6">
                    <div className="gradient-border p-6 card-hover">
                        <div className="flex items-start gap-4">
                         ...
                         <p className="text-muted-foreground">
                            Creating reponive websites and web-application with
                            modern frameworks.
                         </p>
                          </div>
                        </div>
                    ...
                    <div className="gradient-border p-6 card-hover">
                         ...
                         <p className="text-muted-foreground">
                          Deigning intuitive user interfaces and seamless user
                          experiences.                        </p>
                          </div>
                        </div>
                    </div>
